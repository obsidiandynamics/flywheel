...
public final class HttpStubAuthenticatorUncachedPubTest extends AbstractAuthTest {
  ...
  public void testAllow() throws Exception {
    stubFor(post(urlEqualTo(MOCK_PATH))
            ...
            .willReturn(aResponse()
                        ...
                        .withBody(toJson(new StubAuthResponse(AuthenticationOutcome.INDEFINITE)))));
  ...
  public void testDeny() throws Exception {
    stubFor(post(urlEqualTo(MOCK_PATH))
            ...
            .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
                        .withBody(toJson(new StubAuthResponse(null)))));
