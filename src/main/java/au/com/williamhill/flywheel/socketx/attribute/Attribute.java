package au.com.williamhill.flywheel.socketx.attribute;

import static au.com.williamhill.flywheel.socketx.attribute.Attribute.ValueSupplier.*;

import java.util.*;

/**
 *  A strongly-typed value that may be passed as a configuration to an 
 *  {@link au.com.williamhill.flywheel.socketx.XClient} or
 *  an {@link au.com.williamhill.flywheel.socketx.XServer}, where the configuration is 
